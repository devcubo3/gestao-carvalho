      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-destructive">
            ...
            Excluir Carta de Crédito Permanentemente
          </DialogTitle>
          ...
          <div className="grid gap-4 py-4">
            <div className="rounded-lg border border-destructive bg-destructive/10 p-4">
              ...
              <div className="space-y-1 bg-background/50 p-3 rounded">
                ...
                <p className="text-sm text-muted-foreground">Cedente: {credit?.creditor_name}</p>
                <p className="text-sm text-muted-foreground">
                  Valor: {credit?.nominal_value ? formatCurrency(credit.nominal_value) : 'N/A'}
                </p>
              </div>
            ...
            <div className="grid gap-2">
              <Label htmlFor="confirmText" className="text-sm">
                Para confirmar a <strong className="text-destructive">exclusão permanente</strong>, digite{" "}
